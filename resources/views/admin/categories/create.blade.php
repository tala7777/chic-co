...
@section('content')
    <div class="animate-fade-in">
        ...
        <div class="mb-5 d-flex justify-content-between align-items-end">
            <div>
                <h1 class="h2 mb-1" style="font-family: var(--font-heading); font-weight: 700;">Manifest Collection</h1>
                <p class="text-muted small mb-0">Define a new thematic category for your curated archives.</p>
            </div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 extra-small text-uppercase ls-1">
                    ...
                    <li class="breadcrumb-item active text-dark fw-bold">Creator</li>
                </ol>
            </nav>
        </div>
                        ...
                        <div class="col-lg-5 bg-dark d-flex flex-column" style="min-height: 400px;">
                            <div
                                ...
                                <div class="position-absolute top-0 start-0 w-100 h-100 opacity-25" id="categoryPreviewBg"
                                    style="background: url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1000&auto=format&fit=crop') center/cover no-repeat;">
                                </div>

                                <div class="position-relative z-index-1">
                                    <span class="extra-small text-uppercase ls-2 fw-bold opacity-50 mb-3 d-block">Collection
                                        Preview</span>
                                    <h2 class="font-heading mb-3 display-6" id="categoryPreviewName">New Concept</h2>
                                    <div
                                        class="badge bg-primary-subtle text-primary border-0 rounded-pill px-4 py-2 text-uppercase extra-small ls-1 fw-bold">
                                        0 Curated Pieces
                                    </div>
                                    <div class="mt-4" id="discountBadge" style="display: none;">
                                ...
                                <form action="{{ route('admin.categories.store') }}" method="POST">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="name" id="nameInput"
                                                ...
                                                value="{{ old('name') }}" placeholder="e.g. Midnight Onyx">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="url" name="image" id="imageInput"
                                                ...
                                                value="{{ old('image') }}" placeholder="https://image-source.com/photo.jpg">
                                    ...
                                    <div class="mt-5 d-flex gap-3">
                                        <button type="submit"
                                            ...
                                            <i class="fa fa-plus-circle me-2"></i> Create Collection
                                        </button>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            nameInput.addEventListener('input', (e) => {
                previewName.textContent = e.target.value || 'New Concept';
            });
            ...
            imageInput.addEventListener('input', (e) => {
                if (e.target.value) {
                    ...
                    previewBg.style.backgroundImage = "url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1000&auto=format&fit=crop')";
                }
            });
